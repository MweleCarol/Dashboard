  ...
  return (
    <div className='mt-12'>
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        {/* Banner section */}
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-[375px] p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              <p className='font-bold text-gray-400'>Earnings</p>
              <p className='text-2xl'>$63,470</p>
            </div>
          </div>
          <div className='mt-6'>
        ...
        <div className="flex justify-center gap-1 items-center">
          {earningData.map(({title, icon, iconBg, iconColor, amount, percentage, pcColor}) => (
            <div 
              key={title}
             ...
             <div className="mt-10 flex gap flex-wrap justify-center">
              <div className="border-r-1 border-color m-4 pr-10">
                <div>
                 ...
                 <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>$48,760</span>
                  </p>
